...
public final class TextStyleUtil {
     ...
     *             </ul>
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setBullet(@ColorInt final int color,
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setFontProportion(final float proportion) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setFontXProportion(final float proportion) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setStrikethrough() {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setUnderline() {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setSuperscript() {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setSubscript() {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final Blur style) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                   final float dx,
                                   final float dy,
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link TextStyleUtil} instance
     */
    public TextStyleUtil appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(Common.getContext().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            Common.getContext().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(Common.getContext().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(Common.getContext(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
